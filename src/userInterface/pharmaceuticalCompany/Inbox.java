...
public class Inbox extends javax.swing.JPanel {
    ...
    private void populateInbox()
    {
        ...
        dtm.setRowCount(0);
        PharmaceuticalCompanyMail pharmaceuticalCompanyMail = null;
        
        for(WorkRequest workRequest: workQueue.getWorkRequestList())
        {
            if(workRequest.getClass() == PharmaceuticalCompanyMail.class)
            {
                pharmaceuticalCompanyMail = (PharmaceuticalCompanyMail) workRequest;
                Object[] row = new Object[4];
                row[0] = pharmaceuticalCompanyMail.getSender();
                row[1] = pharmaceuticalCompanyMail.getRequestDate();
                row[2] = pharmaceuticalCompanyMail.getSubject();
                row[3] = pharmaceuticalCompanyMail.getMessage();
