 ...
 * @author Abhishek
 */
public class EditPharmacyDetails extends javax.swing.JPanel {

    /**
     * Creates new form EditPharmacyDetails
     */
    Network internationalNetwork;
    Pharmacy pharmacy;
    JPanel managePharmacysProfileCard;
    public EditPharmacyDetails(Network internationalNework, Pharmacy pharmacy, JPanel managePharmacysProfileCard) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblName1.setText("                  Edit Pharmacy Details");
    ...
    private void btnClear2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClear2ActionPerformed
        // TODO add your handling code here:
         ...
         layout.previous(managePharmacysProfileCard);
 ...
 private void populateCountryList()
    ...
    private void populateFields()
    {
        ...
        CityEnterprise cityEnterprise = (pharmacy.getAddress().getCity());
    
        txtName.setText(pharmacy.getName().getFirstName());
       
        txtStreet.setText(pharmacy.getAddress().getStreet());
        txtZipcode.setText((pharmacy.getAddress().getZipcode()));
        StateEnterprise stateEnterprise = pharmacy.getAddress().getState();
        CountryEnterprise countryEnterprise = pharmacy.getAddress().getCountry();
