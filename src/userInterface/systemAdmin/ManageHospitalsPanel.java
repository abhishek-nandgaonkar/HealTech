...
public class ManageHospitalsPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ManageHospitalsPanel
     */
    Network internationalNetwork;
    
    public ManageHospitalsPanel(Network internationalNetwork) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnUpdateHospitalName = new javax.swing.JButton();
        ...
        lblName1.setText("Manage Hospitals");
        ...
        btnUpdateHospitalName.setBackground(new java.awt.Color(255, 255, 255));
        btnUpdateHospitalName.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnUpdateHospitalName.setForeground(new java.awt.Color(0, 153, 0));
        btnUpdateHospitalName.setText("Update Hospital Name");
        btnUpdateHospitalName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUpdateHospitalNameActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnUpdateHospitalName, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(70, 70, 70)
                                        .addComponent(btnUpdateHospitalName)))
                                .addGap(34, 34, 34)
    ...
    private void btnUpdateHospitalNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateHospitalNameActionPerformed
        // TODO add your handling code here:
        
        HospitalEnterprise hospitalEnterprise = (HospitalEnterprise) tblHospitals.getValueAt(tblHospitals.getSelectedRow(), 0);
        hospitalEnterprise.setName(txtHospitalName.getText());

    }//GEN-LAST:event_btnUpdateHospitalNameActionPerformed
    ...
    private void btnUpdateCountryStateCityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateCountryStateCityActionPerformed
        ...
        HospitalEnterprise hospitalEnterprise = (HospitalEnterprise) tblHospitals.getValueAt(tblHospitals.getSelectedRow(), 0);
                ...
                if(!(hospitalEnterprise.getAddress().getCity().equals((CityEnterprise)cmbCityList.getSelectedItem())))
                {
                    if(!(hospitalEnterprise.getAddress().getState().equals((StateEnterprise)cmbStateList.getSelectedItem())))
                    {
                        if(!(hospitalEnterprise.getAddress().getCountry().equals((CountryEnterprise)cmbCountryName.getSelectedItem())))
                        {
                            hospitalEnterprise.getAddress().setCountry((CountryEnterprise)cmbCountryName.getSelectedItem());
                            hospitalEnterprise.getAddress().setState((StateEnterprise)cmbStateList.getSelectedItem());
                            hospitalEnterprise.getAddress().setCity((CityEnterprise)cmbCityList.getSelectedItem());
    ...
    private void btnUpdateAddressBasicsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateAddressBasicsActionPerformed
        ...
        {
            hospitalEnterprise.getAddress().setStreet(txtStreetName.getText());
        }
        if(!(txtZipcode.getText().equals("")))
        {
            hospitalEnterprise.getAddress().setZipcode((txtZipcode.getText()));
        }
    ...
    private void btnApplyFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApplyFilterActionPerformed
        ...
        HospitalEnterprise manufacturingEnterpirse = null;
        ...
        {
            if(manufacturer.getClass() == HospitalEnterprise.class)
            {
                manufacturingEnterpirse = (HospitalEnterprise) manufacturer;
    ...
    private void btnViewDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDetailsActionPerformed
        // TODO add your handling code here:
        int selection = tblHospitals.getSelectedRow();
        HospitalEnterprise hospitalEnterprise = (HospitalEnterprise) tblHospitals.getValueAt(selection, 0);
        
        txtCity.setText(hospitalEnterprise.getAddress().getCity().getName());
        txtHospitalName.setText(hospitalEnterprise.getName());
        txtState.setText(hospitalEnterprise.getAddress().getState().getName());
        txtStreetName.setText(hospitalEnterprise.getAddress().getStreet());
        txtZipcode.setText((hospitalEnterprise.getAddress().getZipcode()));
        
        populateCountryList(cmbCountryName);
        //cmbStateList.setSelectedItem(((StateEnterprise)hospitalEnterprise.getAddress().getState()).getName());
        //cmbCityList.setSelectedItem(((CityEnterprise)hospitalEnterprise.getAddress().getCity()).getName());
    ...
    private javax.swing.JButton btnUpdateHospitalName;
