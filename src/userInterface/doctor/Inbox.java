...
public class Inbox extends javax.swing.JPanel {
    ...
    private void populateInbox() {
        ...
        for (WorkRequest workRequest : workQueue.getWorkRequestList()) {
            if (workRequest.getClass() == DoctorMail.class) {
                doctorMail = (DoctorMail) workRequest;
                Object[] row = new Object[4];
                row[0] = doctorMail;
                row[1] = doctorMail.getRequestDate();
                row[2] = doctorMail.getSubject();
                row[3] = doctorMail.getMessage();
