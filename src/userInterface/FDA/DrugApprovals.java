 ...
 * @author Abhishek
 */
public class DrugApprovals extends javax.swing.JPanel {
    ...
    public DrugApprovals(WorkQueue workQueue, UserAccount userAccount) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblName1.setText("Drug Approvals");
    ...
    private void btnAssignToMeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToMeActionPerformed
        ...
        if(selectedRow > -1)
        {
            DrugApprovalWorkRequest drugApprovalWorkRequest = (DrugApprovalWorkRequest) tblDrugDetails.getValueAt(selectedRow, 0);
            drugApprovalWorkRequest.setReceiver(userAccount);
            drugApprovalWorkRequest.setStatus("Assigned to " + userAccount);
            populateWorkRequestTable();
        ...
        JOptionPane.showMessageDialog(this, "You have assigned the request to yourself");
        }
        else
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        {
            DrugApprovalWorkRequest drugApprovalWorkRequest = (DrugApprovalWorkRequest) tblDrugDetails.getValueAt(selectedRow, 0);
            drugApprovalWorkRequest.setStatus("Approved");
            populateWorkRequestTable();
    ...
    private void btnRejectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRejectActionPerformed
        ...
        {
            DrugApprovalWorkRequest drugApprovalWorkRequest = (DrugApprovalWorkRequest) tblDrugDetails.getValueAt(selectedRow, 0);
            drugApprovalWorkRequest.setStatus("Rejected");
            populateWorkRequestTable();
    ...
    private void btnAddNotesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNotesActionPerformed
        ...
        {
            DrugApprovalWorkRequest drugApprovalWorkRequest = (DrugApprovalWorkRequest) tblDrugDetails.getValueAt(selectedRow, 0);
            drugApprovalWorkRequest.setMessage(txtResult.getText());
    ...
    {
        DrugApprovalWorkRequest drugApprovalWorkRequest;
        ...
        for(WorkRequest wr: workQueue.getWorkRequestList())
        {
            if((wr.getClass() == DrugApprovalWorkRequest.class))
            {
                ...
                row[1] = drugApprovalWorkRequest.getSender();
                row[2] = drugApprovalWorkRequest.getMessage();
                row[3] = drugApprovalWorkRequest.getStatus();
                dtm.addRow(row);
