...
public class UpdatePatientDetails extends javax.swing.JPanel {
    ...
    public UpdatePatientDetails(Patient patient, JPanel userProcessContainer) {
        initComponents();
        this.patient = patient;
        this.userProcessContainer = userProcessContainer;
        
        txtWeight.setText(Float.toString(patient.getWeight()));
        txtHeight.setText(Integer.toString(patient.getHeight().getFeet()));
        txtHeightInches.setText(Integer.toString(patient.getHeight().getInches()));
    }
    ...
    private void initComponents() {
        ...
        lblName1.setText("                                 Update Patient Information");
