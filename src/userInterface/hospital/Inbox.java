...
public class Inbox extends javax.swing.JPanel {
    ...
    private void populateInbox() {
        ...
        dtm.setRowCount(0);
        HospitalMail hospitalMail = null;

        for (WorkRequest workRequest : workQueue.getWorkRequestList()) {
            if (workRequest.getClass() == HospitalMail.class) {
                hospitalMail = (HospitalMail) workRequest;
                Object[] row = new Object[4];
                row[0] = hospitalMail.getSender();
                row[1] = hospitalMail.getRequestDate();
                row[2] = hospitalMail.getSubject();
                row[3] = hospitalMail.getMessage();
